...
| [Desk Lab](apps/desk-lab.html) | Free MSP call sheet for Dell desks. Toggle what’s on the client’s desk (OptiPlex, Precision, WD19, monitor, UPS). Pick a device, flip the photo, tap a real port. Four read-aloud playbooks: dock dark, no display, laptop not charging, dead desk. Panels: `apps/assets/desk-lab/panels/`. | **Free.** No Stripe. | Public: [Sofa-Loaf/desk-lab](https://github.com/Sofa-Loaf/desk-lab). Live path: `apps/desk-lab.html` |
...
| Desk Lab | `apps/desk-lab.html` |
| Desk Lab photo panels | `apps/assets/desk-lab/panels/` |
...
- Desk Lab: **free**. Do not add Stripe. MSP call sheet only — picker, photo panels, labeled port hotspots, read-aloud playbooks.
