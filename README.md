...
| [Desk Lab](apps/desk-lab.html) | Free MSP ticket desk. Tech on a call walks the **client** through OptiPlex, Precision, WD19, Dell monitor, UPS. Scene → labeled ports → match their desk → guided scripts (no dock power, no display, laptop not charging, UPS/outlet dead). Coach lines you can say out loud. | **Free.** No Stripe. | Public: [Sofa-Loaf/desk-lab](https://github.com/Sofa-Loaf/desk-lab). Live path: `apps/desk-lab.html` |
...
- Desk Lab: **free**. Do not add Stripe. MSP ticket desk — not a consumer toy.
